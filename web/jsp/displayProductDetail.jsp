 <%-- 
    Document   : displayProductDetail
    Created on : Feb 11, 2025, 12:51:16 PM
    Author     : quang
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="java.util.Vector,entity.MedicalProducts" %>
<!DOCTYPE html>
    <html lang="en">
    ...
    <% Vector<MedicalProducts> vector = (Vector<MedicalProducts>) request.getAttribute("vector");%>
                ...
                <div class="row mt-5 justify-content-center">
                    <div class="col-12">
                        <div class="section-title text-center">
                            <h3 class="sub-title mb-4"> <%=medical.getName()%> </h3>
                            <p class="para-desc mx-auto text-muted"><%=medical.getDescription()%></p>
                ...
                <div class="row align-items-center">
                    <div class="col-md-5">
                        <div class="slider slider-for">
                            <div><img src="images/pharmacy/shop/<%=medical.getImage()%>" class="img-fluid rounded" alt=""></div>
                    ...
                    <div class="col-md-7 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div class="section-title ms-md-4">
                            <h4 class="title"><%=medical.getName()%></h4>
                            <h5 class="text-muted">$<%=medical.getPrice()%> </h5>
                            ...
                            <p class="text-muted"><%=medical.getDescription()%></p>
