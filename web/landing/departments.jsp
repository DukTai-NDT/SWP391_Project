...
<%@ page import="java.util.Vector, entity.Department" %>
<!DOCTYPE html>
    <html lang="en">
...
<%
    Vector<Department> vectorDepartment = (Vector<Department>) session.getAttribute("dataDepartment");
%>
    <body>
        <!-- Loader -->
        <div id="preloader">
        ...
        <section class="section">
            <div class="container">
                <div class="row">
                    <%  for (Department department : vectorDepartment) {
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                        <div class="card features feature-primary border-0">
                            <div class="icon text-center rounded-md">
                                <i class="<%= department.getIcon() %>"></i>
                            </div>
                            <div class="card-body p-0 mt-3">
                                <a href="#" class="title text-dark h5"><%= department.getDepartmentName() %></a>
                                <p class="text-muted mt-3"><%= department.getDescription() %></p>
