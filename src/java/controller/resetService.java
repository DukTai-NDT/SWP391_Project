...
public class resetService {
    ...
    private final String from = "taindhe181162@fpt.edu.vn";
    private final String password = "rhoc glso wyhf nler";
    ...
    public static void main(String[] args) {
        resetService ew = new resetService();
        String str = ew.generateToken();
